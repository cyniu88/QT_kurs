...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_iDom_Client_t, stringdata) + ofs \
...
const QMetaObject iDom_Client::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_iDom_Client.data,
      qt_meta_data_iDom_Client,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_iDom_Client.stringdata))
